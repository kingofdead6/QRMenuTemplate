  ...
  return (
    <>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-4 text-lg sm:text-xl text-gray-600 font-light">
              Organize your menu items into clear categories
            </p>
          </div>
          ...
          {loading ? (
            <div className="text-center py-20">
              <p className="text-2xl text-gray-500">Loading categories...</p>
            </div>
        ...
        {/* Add Category Modal (Mobile-First) */}
        <AnimatePresence>
          {showAddModal && (
            <motion.div
              ...
              >
                <div className="p-6 sm:p-8">
                  ...
                  <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl sm:text-3xl font-extralight">Add New Category</h2>
                    <button
                      onClick={() => setShowAddModal(false)}
