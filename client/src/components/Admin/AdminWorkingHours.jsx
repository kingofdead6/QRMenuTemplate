...
export default function AdminWorkingHours() {
  ...
  const handleSave = async (e) => {
    ...
    if (!timeFormat.test(openTime) || !timeFormat.test(closeTime)) {
      return toast.error("Please enter valid times in HH:MM format (e.g., 09:30)");
    }
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg sm:text-xl text-gray-600 font-light">
              Set the daily opening and closing times for your restaurant
            </p>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-lg border border-gray-200 p-10 mb-8">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Current Hours</h2>
                  <p className="text-gray-600">Displayed on the menu page</p>
                </div>
              </div>
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="text-center">
                  <p className="text-sm uppercase tracking-wider text-gray-500 mb-2">Opens</p>
                  <p className="text-5xl font-bold text-gray-900">
                    {formatDisplayTime(openTime)}
                  </p>
                  <p className="text-lg text-gray-600 mt-2">24-hour: {openTime}</p>
                </div>
                <div className="text-center">
                  <p className="text-sm uppercase tracking-wider text-gray-500 mb-2">Closes</p>
                  <p className="text-5xl font-bold text-gray-900">
                    {formatDisplayTime(closeTime)}
                  </p>
                  <p className="text-lg text-gray-600 mt-2">24-hour: {closeTime}</p>
                </div>
              </div>
            )}
          </div>
                ...
                >
                  <div className="p-6 sm:p-8">
                    ...
                    <div className="flex justify-between items-center mb-8">
                      <h2 className="text-2xl sm:text-3xl font-extralight">Edit Working Hours</h2>
                      <button
                        onClick={() => setIsEditing(false)}
                    ...
                    <form onSubmit={handleSave} className="space-y-8">
                      ...
                      <div>
                        ...
                        />
                        <p className="text-sm text-gray-500 mt-2 text-center">
                          Example: 22:30, 02:00 (for late night)
                        </p>
                      </div>
