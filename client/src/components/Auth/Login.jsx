          ...
          <div className="p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="admin@azurebistro.com"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full pl-14 pr-14 py-5 rounded-2xl border-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 transition ${
              ...
              <button
                type="submit"
                disabled={loading}
                className="cursor-pointer w-full py-6 mt-8 bg-gradient-to-r from-blue-600 to-blue-700 text-white text-xl font-bold rounded-2xl hover:from-blue-700 hover:to-blue-800 transition shadow-xl disabled:opacity-70 disabled:cursor-not-allowed"
              >
